...
import { secureBackupRecoveryKey } from "./recovery-key";

export function createSecureBackup(distortionData: Distortion.Data) {
  ...
  return secureBackup(distortionData, recoveryKeys, {
    ...
    async isAccessible(directoryUri) {
      return directoryUri === defaultDirectory.uri && defaultDirectory.exists;
    },
